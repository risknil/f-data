...
import { AdBanner, DismissibleMobileAd } from '@/components/ad-banner'
...
export default async function Home() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="hidden sm:block mx-auto w-full max-w-7xl px-4 pt-4 sm:px-6 lg:px-8">
      ...
      <div className="flex justify-center">
        ...
        <main className="flex-1 max-w-7xl">
          ...
          {/* Mobile ad - after hero (dismissible) */}
          <DismissibleMobileAd autoDismissSeconds={6} />

          {/* Mobile ad - after hero (static) */}
          <div className="mx-auto w-full px-4 py-2 sm:hidden">
          ...
          {/* Desktop inline ad */}
          <div className="hidden sm:block mx-auto w-full max-w-7xl px-4 pb-6 sm:px-6 lg:px-8">
            <AdBanner position="inline" />
          </div>

          {/* Mobile ad - dismissible before CTA */}
          <DismissibleMobileAd autoDismissSeconds={8} />
          ...
          <div className="hidden sm:block mx-auto w-full max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <AdBanner position="leaderboard" />
          </div>
