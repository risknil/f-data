...
const hu: Translations = {
  ...
  expertPicks: { badge: 'Prémium szakértői tippek', title: 'Mire fogadunk', description: 'Hamarosan - Maradjon velünk a szakértői kombó tippjeinkért!', noTips: 'Jelenleg nincs elérhető prémium tipp. Nézzen vissza hamarosan!', selectionsLabel: 'kiválasztás', oddsLabel: 'kombinált odds', combinedOdds: 'Kombinált odds', unlockButton: 'Feloldás $1-ért', unlockTitle: 'A mi {sheetName} kombó tippünk', revealNote: 'Feloldás után látható marad a következő tippig', howItWorksTitle: 'Hogyan működik:', howItWorksDesc: 'Mindössze $1-ért kombónként feloldhatja szakértőnk többszörös fogadását. Minden kombó több tippet kombinál a nagyobb potenciális nyereményért.' },
