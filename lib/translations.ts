...
const zhCN: Translations = {
  ...
  hero: { title: '免费专家投注技巧', subtitle: '从专家那里获得最佳投注技巧 — 完全免费', description: '为什么要花几个小时浏览不可靠的投注网站或为可疑的选择付费？我们从数百个专家来源汇总技巧，只提供最高质量的选择 — 完全免费。', startButton: '开始获取免费技巧', learnButton: '了解如何运作' },
  ...
  expertPicks: { badge: '高级专家选择', title: '我们在投注什么', description: '想知道我们的专家团队在投注什么吗？只需$1即可获得我们高级累积投注选择的独家访问权限。', noTips: '目前没有高级选择。请稍后再来！', selectionsLabel: '选择', oddsLabel: '组合赔率', combinedOdds: '组合赔率', unlockButton: '解锁 $1', unlockTitle: '我们的{sheetName}累积投注技巧', revealNote: '一旦揭示，将保持可见直到下一个选择', howItWorksTitle: '如何运作：', howItWorksDesc: '只需每个累积投注$1，解锁我们专家的多选投注。每个累积投注组合多个选择以获得更大的潜在回报。' },
...
const hu: Translations = {
  ...
  expertPicks: { badge: 'Prémium szakértői tippek', title: 'Mire fogadunk', description: 'Szeretné tudni, mire fogad a szakértői csapatunk? Szerezzen exkluzív hozzáférést prémium kombó tippjeinkhez mindössze $1-ért.', noTips: 'Jelenleg nincs elérhető prémium tipp. Nézzen vissza hamarosan!', selectionsLabel: 'kiválasztás', oddsLabel: 'kombinált odds', combinedOdds: 'Kombinált odds', unlockButton: 'Feloldás $1-ért', unlockTitle: 'A mi {sheetName} kombó tippünk', revealNote: 'Feloldás után látható marad a következő tippig', howItWorksTitle: 'Hogyan működik:', howItWorksDesc: 'Mindössze $1-ért kombónként feloldhatja szakértőnk többszörös fogadását. Minden kombó több tippet kombinál a nagyobb potenciális nyereményért.' },
