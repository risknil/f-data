...
const es: Translations = {
  ...
  expertPicks: { badge: 'Picks Acumuladores de Expertos', title: 'En qué estamos apostando', description: 'Próximamente - ¡Mantente atento a nuestros picks acumuladores de expertos!', noTips: 'No hay picks acumuladores de expertos disponibles en este momento. ¡Vuelve pronto!', selectionsLabel: 'selecciones', oddsLabel: 'cuotas combinadas', combinedOdds: 'Cuotas Combinadas', unlockButton: 'Desbloquear por $1', unlockTitle: 'Nuestro Tip Acumulador de {sheetName}', revealNote: 'Una vez revelado, permanece visible hasta el próximo pick', howItWorksTitle: 'Cómo funciona:', howItWorksDesc: 'Por solo $1 por acumulador, desbloquea la apuesta múltiple de nuestro experto. Cada acumulador combina múltiples picks para mayores retornos potenciales.' },
...
const zhCN: Translations = {
  ...
  expertPicks: { badge: '专家累积投注', title: '我们在投注什么', description: '即将推出 - 敬请期待我们的专家累积投注选择！', noTips: '目前没有专家累积投注选择。请稍后再来！', selectionsLabel: '选择', oddsLabel: '组合赔率', combinedOdds: '组合赔率', unlockButton: '解锁 $1', unlockTitle: '我们的{sheetName}累积投注技巧', revealNote: '一旦揭示，将保持可见直到下一个选择', howItWorksTitle: '如何运作：', howItWorksDesc: '只需每个累积投注$1，解锁我们专家的多选投注。每个累积投注组合多个选择以获得更大的潜在回报。' },
...
const hu: Translations = {
  ...
  expertPicks: { badge: 'Szakértői kombó tippek', title: 'Mire fogadunk', description: 'Hamarosan - Maradjon velünk a szakértői kombó tippjeinkért!', noTips: 'Jelenleg nincs elérhető szakértői kombó tipp. Nézzen vissza hamarosan!', selectionsLabel: 'kiválasztás', oddsLabel: 'kombinált odds', combinedOdds: 'Kombinált odds', unlockButton: 'Feloldás $1-ért', unlockTitle: 'A mi {sheetName} kombó tippünk', revealNote: 'Feloldás után látható marad a következő tippig', howItWorksTitle: 'Hogyan működik:', howItWorksDesc: 'Mindössze $1-ért kombónként feloldhatja szakértőnk többszörös fogadását. Minden kombó több tippet kombinál a nagyobb potenciális nyereményért.' },
...
const ko: Translations = {
  ...
  footer: { company: '회사', sports: '스포츠', account: '계정', howItWorks: '작동 방식', terms: '서비스 약관', privacy: '개인정보 보호정책', signUp: '무료 가입', logIn: '로그인', forgot: '비밀번호 찾기', tagline: '스포츠 베팅 팁을 얻는 가장 스���트한 방법. 수백 명의 전문가가 선별, 모든 사람에게 무료.', disclaimer: '책임감 있게 도박하세요. 베팅에는 위험이 따릅니다. 18세 이상.' },
